...
#ifndef PAD_MATCHES_H
#define PAD_MATCHES_H 1
...
def generate_oxm_header_code(fields):
    ...
    return OXM_HEADER_BEGIN_END % code
...
def generate_oxm_experimental_part(fields):
    ...
    oxm_code_files_dir = ROFL_DIR + '/rofl-core/src/rofl/common/openflow/experimental/matches/'
        
    generate_file(oxm_code_files_dir + '%s_matches.h' % header, generate_oxm_header_code(fields))
    ...
    generate_file(oxm_code_files_dir + '%s_matches.cc' % header, generate_oxm_code(fields))
    generate_file(oxm_code_files_dir + 'Makefile.am', generate_makefile_am(fields))
...
def generate_rofl_pipeline_part(fields):
    ...
    generate_file(rofl_pipeline_files_dir + '/of1x_match_autogenerated.h', generate_openflow_pipeline_match_h(fields))
    generate_file(rofl_pipeline_files_dir + '/of1x_match_autogenerated.c', generate_openflow_pipeline_match_c(fields))
    generate_file(rofl_pipeline_files_dir + '/of1x_packet_matches.h', generate_openflow_pipeline_packet_matches_h(fields))
    generate_file(rofl_pipeline_files_dir + '/of1x_packet_matches.c', generate_openflow_pipeline_packet_matches_c(fields))
    
    generate_file(ROFL_DIR + '/rofl-core/src/rofl/datapath/pipeline/platform/packet_autogenerated.h', generate_openflow_pipeline_platform_packet_h(fields))
    
    
def generate_code_files(fields):
    # Files in /rofl-core/src/rofl/common/
    generate_oxm_experimental_part(fields)
    generate_file(ROFL_DIR + '/rofl-core/src/rofl/common/openflow/openflow_experimental.h', generate_openflow_experimental(fields)) # causes long time recompile
    
    generate_rofl_pipeline_part(fields)
    

    
generate_code_files([{'header': 'pad_tag', 'field':'a', 'length':'8'}, 
