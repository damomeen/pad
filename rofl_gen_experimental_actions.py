...
def generate_openflow_pipeline_action_h(fields):
    skeleton = read_template("templates/of1x_action.h.template")
...
def generate_openflow_pipeline_action_c(fields):
    skeleton = read_template("templates/of1x_action.c.template")  
...
def generate_experimental_action_h(fields):
    skeleton = read_template("templates/rofl_experimental_actions.h.template") 
    fields[0]['experimental_id'] = 3
    return skeleton % fields[0]
    
def generate_experimental_action_c(fields):
    skeleton = read_template("templates/rofl_experimental_actions.c.template") 
    return skeleton % fields[0]
...
def generate_datapath_pipeline_platform_actions_h(fields):
    skeleton = read_template("templates/packet_actions.h.template")  
